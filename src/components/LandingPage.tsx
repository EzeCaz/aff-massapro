...
import { Shield, Users, ArrowRight, LogIn, UserPlus } from 'lucide-react'
      ...
      <header className="border-b border-purple-100 bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="https://aff.massapro.com/android-chrome-192x192.png" alt="MassaPro" className="w-10 h-10 rounded-xl" />
            <div>
        ...
        <div className="max-w-4xl w-full">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-700 text-sm font-medium px-4 py-2 rounded-full mb-6">
              <img src="https://aff.massapro.com/android-chrome-192x192.png" alt="" className="w-4 h-4 rounded" />
